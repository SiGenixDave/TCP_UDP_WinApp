...
namespace TCPServerTest
{
    ...
    public class TcpServer
    {
        ...
        private void ConnectionReady_Handler (IAsyncResult ar)
        {
            lock (this)
            {
                ...
                {
                    _uiForm.UpdateTestBox ("New Client Connected" + System.Environment.NewLine);
    ...
    public class EchoServiceProvider : TcpServiceProvider
    {
        ...
        public EchoServiceProvider (TCPServerTest uiForm)
        {
            _uiForm = uiForm;
        }
        ...
        {
            return new EchoServiceProvider (_uiForm);
        }
        ...
        public override void OnReceiveData (ConnectionState state)
        {
            ...
            while (state.AvailableData > 0)
            {
                ...
                if (readBytes > 0)
                {
                    ...
                    _uiForm.UpdateTestBox (_receivedStr + System.Environment.NewLine);
